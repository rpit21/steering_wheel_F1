...
int main(void)
{
	...
	//HAL_LPIT0_Init(); // Initialization for the delays;
     ...
     */
	//HAL_LPIT_DelayMs(500);
	//HAL_DelayMs(500);
    //HAL_UART_Printf("[BOOT] Entering app_main()\r\n");
    //app_main();

	//HAL_UART_Printf("[BOOT] Entering tftnxp_main\r\n");
    //tftnxp_main();

    HAL_UART_Printf("[BOOT] Entering ili_test\r\n");
    ili_main();
